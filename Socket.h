...
typedef void (*SAL_Socket_ReadCallback)(const uint8* const buffer, const uint32 length, const void* state);
...
public void SAL_Socket_RegisterReadCallback(SAL_Socket socket, SAL_Socket_ReadCallback callback, const void* const state);
