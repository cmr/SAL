...
typedef void (*SAL_Socket_ReadCallback)(uint8* buffer, uint32 length, void* state);
...
public void SAL_Socket_RegisterReadCallback(SAL_Socket socket, SAL_Socket_ReadCallback callback, void* state);
